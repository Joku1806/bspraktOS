...
#define DISTINCT_SECTIONS_COUNT (15)
...
#define UBSS_UDATA_KERNEL_MAP_START_ADDRESS (7 * MiB)
#define UBSS_UDATA_KERNEL_ORIGINAL_MAP_START_ADDRESS (15 * MiB)

#define UNASSIGNED1_START_ADDRESS (16 * MiB)
...
#define USER_STACK_TOP_ADDRESS KERNEL_STACK_BOTTOM_ADDRESS
#define USER_STACK_BOTTOM_ADDRESS (USER_STACK_TOP_ADDRESS - (USER_STACK_COUNT * STACK_SIZE))
#define VIRTUAL_PROCESS_STACKS_TOP_ADDRESS USER_STACK_BOTTOM_ADDRESS
#define VIRTUAL_PROCESS_STACKS_BOTTOM_ADDRESS (USER_STACK_BOTTOM_ADDRESS - 4 * MiB)

#define USER_STACK_KERNEL_ONLY_MAPPING_START_ADDRESS (USER_STACK_BOTTOM_ADDRESS)
